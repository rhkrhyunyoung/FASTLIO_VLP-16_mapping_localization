...
# How to Run
1. Mapping
```bash ros2 launch fast_lio mapping.launch.py config_file:=velodyne.yaml```
...
```bash ros2 service call /map_save std_srvs/srv/Trigger {}```
...
3. Localization
```bash ros2 launch fast_lio localization.launch.py map:=/path/to/your/map_result/my_fast_lio_map.pcd```
